...
def index():
    ...
    stats = {
        ...
        'rev_table' : df2[['Category','App','Reviews','Rating']].sort_values('Reviews', ascending = False).reset_index().drop('index', axis = 1).to_html(classes=['table thead-light table-striped table-bordered table-hover table-sm'])
    }
    ...
    ## Buatlah sebuah plot yang menampilkan insight di dalam data -- Type Distribution
